# SuperSpec - Claude Code 環境下使用 Superpowers + Spec-Kit 整合開發流程(修正版 v2026.04.25a)
...
| 步驟 | 標籤 | 動作 | 說明 |
|---|---|---|---|
| 0.1 | 【Shell端】 | `uvx --from git+https://github.com/github/spec-kit.git@<tag> specify init <project> --integration claude` | 為專案裝上指定tag版本的 **Spec-Kit** |
